Feature: Student register
  ...
  Scenario: As a student, I want to register a new student account
    ...
    When I fill in "eb_user_registration_student_email" with "emi.berea+student-101@gmail.com"
    ...
    And I should see "Congrats emi.berea+student-101@gmail.com, your account is now activated."
